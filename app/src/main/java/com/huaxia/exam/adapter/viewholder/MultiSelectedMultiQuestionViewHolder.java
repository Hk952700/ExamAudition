...
public class MultiSelectedMultiQuestionViewHolder extends RecyclerView.ViewHolder {
    ...
    public final RelativeLayout mAnswer_nine_selected_five_item1_rel;
    public final ImageView mAnswer_nine_selected_five_item1_imageview;//背景图片
    public final TextView mAnswer_nine_selected_five_item1_textview;//内容文字
