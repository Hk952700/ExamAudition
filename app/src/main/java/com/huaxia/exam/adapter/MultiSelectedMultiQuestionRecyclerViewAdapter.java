        ...
        if (mCount == 5) {
            switch ((i + 1)) {
                case 1:
                    ...
                    layoutParams1.rightMargin = (int) mContext.getResources().getDimension(R.dimen.dp_106);
            ...
            switch ((i + 1)) {
                case 1:
                    layoutParams1.leftMargin = 0;
                    layoutParams1.rightMargin = (int) mContext.getResources().getDimension(R.dimen.dp_40);
                    answerNineSelectedFiveQuestion.mAnswer_nine_selected_five_item1_rel.setLayoutParams(layoutParams1);
                    break;
                case 2:
                    layoutParams1.leftMargin = 0;
